...
import { ContentColumnsData, ContentRowsData } from '../../libs/tableHeaders/ContentTable' 
...
export default class TableContent extends Component {
  render() {
    return (
      <WrapperTableContent>
        <Table columns={ContentColumnsData} dataSource={ContentRowsData} pagination={false} />
      </WrapperTableContent>
    );
  }
}
